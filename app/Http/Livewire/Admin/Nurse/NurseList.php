...
class NurseList extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.nurse.nurse-list', [
            'users' => $queryData
    ...
    {
        User::destroy($id);
        $this->showModal('success', 'Success', 'Nurse has been deleted successfully');
    }
    public function deleteAttempt($id)
    {
        $this->showConfirmation("warning", 'Are you sure?', "You won't be able to recover this nurse!", 'Yes, delete!', 'deleteConfirm', ['id' => $id]); //($type,$title,$text,$confirmText,$method)
    }
