<x-admin.form-section submit="saveOrUpdate">
    <x-slot name="form">
        ...
        <x-admin.form-group>
            <x-admin.lable value="Skill Name" required />
            <x-admin.input type="text" wire:model.defer="skill_name" placeholder="Skill Name"  class="{{ $errors->has('skill_name') ? 'is-invalid' :'' }}" />
            <x-admin.input-error for="skill_name" />
        </x-admin.form-group>
