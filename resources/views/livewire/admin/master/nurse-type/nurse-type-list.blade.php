<x-admin.table>
    ...
    <x-slot name="PageButton">
        <div class="subadmin_btn">
            <a href="{{route('projects.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">+ Add New Projects</a>
        </div>
    </x-slot>
    ...
    <x-slot name="tbody">
        @forelse($types as $data)
            <tr role="row" class="odd">
                ...
                <x-admin.td-action>
                    <a class="dropdown-item" href="{{ route('projects.edit', ['project' => $data->id]) }}"><i class="la la-edit"></i> Edit</a>
