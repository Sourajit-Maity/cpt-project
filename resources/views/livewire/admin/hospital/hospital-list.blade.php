    ...
    <x-slot name="tbody">
        @forelse($users as $user)
            <tr role="row" class="odd">
                ...
                <x-admin.td-action>
                    <a class="dropdown-item" href="{{ route('hospital.edit', ['hospital' => $user->id]) }}"><i
                            class="la la-edit"></i> Edit</a>
                            <a class="dropdown-item" href="{{ route('admin.hospital.details', ['hospital' => $user->id]) }}"><i class="la la-eye"></i>  Details</a>
