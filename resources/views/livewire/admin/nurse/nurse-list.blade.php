    ...
    <x-slot name="tbody">
        @forelse($users as $user)
            <tr role="row" class="odd">
                ...
                <x-admin.td-action>
                    <a class="dropdown-item" href="{{ route('nurse.edit', ['nurse' => $user->id]) }}"><i
                            class="la la-edit"></i> Edit</a>
                    <a class="dropdown-item" href="{{ route('admin.nurse.info', ['nurse' => $user->id]) }}"><i class="la la-eye"></i> Nurse Details</a>
