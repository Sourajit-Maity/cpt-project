		...
		<div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
			<div class="kt-aside__brand-logo">
				<a href="{{route('admin.dashboard')}}" class="logo_text_custom">
					 ...
					 <!-- <span width="150px" height="50px">{{  ('C.P.T') }}</span>  -->
					<img alt="Logo" src="{{asset('admin_assets/logo/logo2.jpg')}}" width="150px" height="50px"/>
				</a>
			</div>
		...
		<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
			<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
				<ul class="kt-menu__nav ">
					...
					<li class="kt-menu__item {{ Request::is('admin/projects*') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true"><a href="{{route('projects.index')}}" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-spinner"><span></span></i><span class="kt-menu__link-text">Project List</span></a></li>
				

					<li class="kt-menu__section ">
						<h4 class="kt-menu__section-text">Job Management</h4>
						<i class="kt-menu__section-icon flaticon-more-v2"></i>
					</li>
					...
					<li class="kt-menu__item {{ Request::is('admin/payments*') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true"><a href="{{route('payments.index')}}" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-spinner"><span></span></i><span class="kt-menu__link-text">Payment List</span></a></li>
